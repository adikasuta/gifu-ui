  ...
  <div>
    <v-hover v-slot="{ hover }">
      <div v-if="hover" class="d-flex">
        <v-card class="py-2 px-3 white--text"
          style="display: inline-block; box-shadow: 4px 4px 8px 0 rgba(0, 0, 0, 0.2); width: 240px; height: 150px; border-radius: 10px; background-image: linear-gradient(to right bottom, #946af8, #bb60e0, #d459c7, #e258af, #e95c99, #f3658a, #f8707c, #f97e71, #fe9267, #fea761, #fabc60, #f1d267);">
          <v-img src="../images/visa-white.png" max-width="50"></v-img>
          <div class="px-2 pt-6 justify-space-between"
            style="font-family: 'Noto Sans Mono', monospace !important; font-size: 14px; letter-spacing: 2px">
            {{ paymentInstrument.panNumber }}
          </div>
          <div class="d-flex  justify-space-between">
            <div class="px-2 pt-2" style="font-size: 11px; font-weight: 600; text-transform: uppercase;">
              {{ paymentInstrument.firstName }} {{ paymentInstrument.lastName }}
            </div>
            <div class="px-3"
              style="font-size: 12px; font-family: 'Noto Sans Mono', monospace !important; padding-top: 7px">
        ...
        <v-card>
          <v-list>
            <v-list-item v-for="(action, index) in defaultCreditCardActions" :key="index" @click="action.action">
              <v-list-item-content>
      ...
      <div v-else style="width: 240px">
        <v-card class="py-2 px-3 white--text"
          style="display: inline-block; width: 240px; height: 150px; border-radius: 10px; background-image: linear-gradient(to right bottom, #946af8, #bb60e0, #d459c7, #e258af, #e95c99, #f3658a, #f8707c, #f97e71, #fe9267, #fea761, #fabc60, #f1d267);">
          <v-img src="../images/visa-white.png" max-width="50"></v-img>
          <div class="px-2 pt-6 justify-space-between"
            style="font-family: 'Noto Sans Mono', monospace !important; font-size: 14px; letter-spacing: 2px">
            {{ paymentInstrument.panNumber }}
...
<script>
import "../filters/CardNumber.filter";
